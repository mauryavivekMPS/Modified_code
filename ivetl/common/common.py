...
PIPELINES = [
    {
        ...
        'tasks': [
            ...
            'ivetl.pipelines.publishedarticles.tasks.FilterArticlesTask',
    ...
    },
    {
        ...
        'visible_on_publisher_user_home': False,
...
def get_validator_class(pipeline):
    ...
    print(validator_module_name,class_name)
...
TABLEAU_WORKBOOK_ID_BY_NAME = {w['name']: w['id'] for w in TABLEAU_WORKBOOKS}
...
BENCHPRESS_BUCKET = os.environ.get('IVETL_BENCHPRESS_BUCKET', 'prod-bp-vizor')
...
API_CACHE_SERVER = os.environ.get('IVETL_API_CACHE_SERVER', '10.0.1.202:8080')
