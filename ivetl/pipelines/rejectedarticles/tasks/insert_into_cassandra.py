                ...
                if publisher_id == 'aaas' and (data['submitted_journal'] == 'Signaling' or data['submitted_journal'] == 'Translational Medicine'):
                    def test_file_of_thread(text,data=None,Skipped_record_file_name=None):
                        ...
                        try:
                            ...
                            Thread_lock.release()
                    test_file_of_thread("Skipping this record Because publishers id 'aaas' and Submitted_journal %s "%data['submitted_journal'],manuscript_id,Skipped_record_file_name)
