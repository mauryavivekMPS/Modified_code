...
class MendeleyLookupTask(Task):
    def run_task(self, publisher_id, product_id, pipeline_id, job_id, work_folder, tlogger, task_args):
        ...
        def process_manuscript_rows(manuscript_rows_for_this_thread):
            ...
            # def test_file_of_thread(text,data=None):
            #     file_path = "/home/vivek/new_file_for_thread.txt"
            #     lock_path = "/home/vivek/new_file_for_thread.txt.lock"
            ...
            for article_row in manuscript_rows_for_this_thread:
                ...
                if data['status'] == "Match found":
                    ...
                    try:
                        ...
                        # test_file_of_thread("No saves founds for this Manuscript_id",manuscript_id)
                        tlogger.info("No saves, skipping")
                else:
                    # test_file_of_thread("No match found for %s skipped"% manuscript_id,manuscript_id)
