...
def home(request):
    if request.user.is_superuser:
        ...
        for publisher in request.user.get_accessible_publishers():
            ...
            for product_id in publisher.supported_products:
                ...
                for pipeline in product['pipelines']:
                    ...
                    if recent_runs['skipped_row_data'] != {}:
                        skipped_row_data_List.append(recent_runs['skipped_row_data'])
        ...
        return render(request, 'home.html', {
            ...
            'skipped_row_data_list' : skipped_row_data_List if skipped_row_data_List != [] else [{"Job_id":"blank"}] 
        })
